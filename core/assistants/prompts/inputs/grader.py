...
def grade_question_prompt(schema: str = None):
    prompt = """
        ...
        **CRITICAL RULE**: If the question is relevant to the dataset (relevance score ≤ 6), it should be enriched rather than rejected, even if it's vague or incomplete. Only irrelevant questions should be rejected.
